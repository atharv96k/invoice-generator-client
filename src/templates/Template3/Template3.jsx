            ...
            <div className="d-flex justify-content-end mb-4">
                <div className="template3-total-box">
                    <div className="d-flex justify-content-between mb-2">
                        <span>Sub Total:</span>
                        <span>{data.currencySymbol}{Number(subtotal).toFixed(2)}</span>
                    </div>
                    <div className="d-flex justify-content-between mb-2">
                        <span>Tax ({data.tax}%):</span>
                        <span>{data.currencySymbol}{Number(taxAmount).toFixed(2)}</span>
                    </div>
                    <div className="d-flex justify-content-between fw-bold template3-total">
                        <span>Total:</span>
                        <span>{data.currencySymbol}{Number(total).toFixed(2)}</span>
                    </div>
                </div>
            </div>
