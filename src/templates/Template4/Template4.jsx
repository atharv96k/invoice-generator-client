                ...
                <div style={{ width: '100%', maxWidth: '400px' }}>
                    <table className="table table-bordered mb-0">
                        ...
                        <tr>
                            ...
                            <td className="text-end">{data.currencySymbol}{Number(subtotal).toFixed(2)}</td>
                        </tr>
                        <tr>
                            <td><strong>Tax ({data.tax}%)</strong></td>
                            <td className="text-end">{data.currencySymbol}{Number(taxAmount).toFixed(2)}</td>
                        </tr>
                        <tr>
                            <td className="fw-bold template4-table-head"><strong>Total Due Amount</strong></td>
                            <td className="text-end fw-bold template4-table-head">{data.currencySymbol}{Number(total).toFixed(2)}</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
